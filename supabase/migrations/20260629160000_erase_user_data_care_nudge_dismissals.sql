-- Extend account erasure for care_nudge_dismissals (Phase D).
...
BEGIN
  ...
  DELETE FROM public.care_nudge_dismissals WHERE user_id = p_user_id;
  GET DIAGNOSTICS n = ROW_COUNT;
  summary := summary || jsonb_build_object('care_nudge_dismissals', n);
