...
Under **Profile** → **Reminders**, tap the row to open the full **Reminders** screen (between **My Pets** and **Settings**). The row subtitle shows your current summary (journal time and which push alerts are on).

On the **Reminders** screen you can configure:
