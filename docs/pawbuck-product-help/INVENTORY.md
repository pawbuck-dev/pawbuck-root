...
| Pet profile & health hub | `02-pet-profile-health-record.md` | `pet-profile`, `health-record/[id]` |
...
| Settings & notifications | `12-settings-notifications.md` | `settings`, device settings |
